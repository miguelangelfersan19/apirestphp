...
class pacientes extends conexion{
        ...
        if (!isset($datos['token'])) {
            ...
            if($arrayToken){
                ...
                if(!isset($datos['nombre']) || !isset($datos['dni']) || !isset($datos['correo'])){
                    ...
                    //validacion de datos solicitados
                    if(isset($datos['telefono'])){$this->telfono = $datos['telefono'];}
    ...
    public function put($json){
        ...
        return $_respuestas->error_401(" El token que envio es invalido o ja caducado! ");
       }
      } 
    }
    ...
    private function modificarPaciente(){
          ...
          "',Direccion = '" . $this->direccion . "', DNI = '" . $this->dni .
           "', CodigoPostal = '" . $this->codigoPostal . "', Telefono = '" . $this->telefono .
            "', Genero = '" . $this->genero . "', FechaNacimiento = '" . $this->fechaNacimiento .
             "', Correo = '" . $this->correo .
